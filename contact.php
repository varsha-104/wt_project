              ...
              <div class="row">
                <div class="col-md-6 padding_left_0">
                  <div class="mail_section">
                    ...
                    <input type="" class="mail_text_1" placeholder="Phone Number" name="phone">
                    ...
                    <div class="send_bt"><button class="btn" type="submit" class="btn-primary" name="send">Submit</button></div>
                  </div>
                </div>
